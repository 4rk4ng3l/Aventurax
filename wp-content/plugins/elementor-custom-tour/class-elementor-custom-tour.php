...
/**
 * Main Elementor CustomTour Class
 *
 * The init class that runs the Elementor CustomTour plugin.
 ...
 */
final class Elementor_Custom_Tour {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-custom-tour' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_CUSTOM_TOUR ) );
...
// Instantiate Elementor_CustomTour.
new Elementor_Custom_Tour();
