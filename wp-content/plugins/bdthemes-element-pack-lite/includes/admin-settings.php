...
class ElementPack_Admin_Settings {
    ...
    function __construct() {
        ...
        add_action('admin_notices', [$this, 'element_pack_notice']);
        ...
        $settings_fields = [
            'element_pack_active_modules' => [
                ...
                [
                    ...
                    'demo_url'     => 'https://elementpack.pro/demo/element/advanced-calculator/',
                ...
                [
                    ...
                    'demo_url'     => 'https://elementpack.pro/demo/element/barcode',
                ...
                [
                    ...
                    'widget_type'  => 'free',
                    'content_type' => 'custom new',
                    'demo_url'     => 'https://elementpack.pro/demo/element/image-stack/',
                    'video_url'    => '',
                ],
                [
                ...
                [
                    ...
                    'widget_type'  => 'free',
                    'content_type' => 'custom new',
                    'demo_url'     => 'https://elementpack.pro/demo/element/review-card/',
                    'video_url'    => '',
                ],
                [
                    'name'         => 'slider',
                ...
                [
                    ...
                    'demo_url'     => 'https://elementpack.pro/demo/element/static-carousel',
                    'video_url'    => '',
                ],
                [
                    'name'         => 'single-post',
            ...
            'element_pack_elementor_extend' => [
                [
                    'name'         => 'widget_confetti_show',
                    'label'        => esc_html__('Confetti Effects', 'bdthemes-element-pack'),
                    'type'         => 'checkbox',
                    'default'      => "off",
                    'widget_type'  => 'pro',
                    'content_type' => 'new',
                    'demo_url'     => 'https://elementpack.pro/demo/element/confetti-effects',
                ...
                [
                    'name'        => 'section_tile_scroll_show',
                    'label'       => esc_html__('Tile Scroll', 'bdthemes-element-pack'),
                    'type'        => 'checkbox',
                    'default'     => "off",
                    'widget_type' => 'pro',
                    'content_type' => 'new',
                    'demo_url'    => 'https://elementpack.pro/demo/element/tile-scroll/',
                ...
                [
                    ...
                    'widget_type'  => 'pro',
                    'content_type' => 'new',
                    'demo_url'     => 'https://elementpack.pro/demo/element/wrapper-link',
                ...
                [
                    ...
                    'widget_type'  => 'pro',
                    'content_type' => 'new',
                    'demo_url'     => 'https://elementpack.pro/demo/element/scroll-box/',
                    'video_url'    => '',
                ],
                [
                    'name'         => 'wrapper_link',
                  ...
                  <div class="bdt-width-1-2@l">
                    <div class="bdt-card bdt-card-body bdt-card-blue ep-facebook-community">
                      ...
                      <a class="bdt-button bdt-btn-red bdt-margin-small-top bdt-text-bold" target="_blank" rel=""
                         href="https://downloads.wordpress.org/plugin/ultimate-post-kit.zip">Free Download</a>
                    ...
                    <div class="bdt-width-1-3@m">
                        <div class="ep-video-tutorial bdt-card bdt-card-body bdt-card-green">
                            ...
                            <ul class="bdt-list bdt-list-divider" bdt-lightbox>
                                <li>
                                <a href="https://youtu.be/F2cy_RpqWWQ">
                                    <h4 class="ep-link-title">What's New in Version V5.14.X</h4>
                                </a>
                                </li>
                                <li>
    ...
    function script() {
        ...
        <style>
            #element-pack-notice-id-promo-notice {
                background-image: url(<?php echo BDTEP_ASSETS_URL; ?>/images/ );
            }
        </style>
    ...
    public function element_pack_notice() {
        ...
        //         'dismissible'      => true,
        //         'dismissible-time' => 0,
        //         'message'          => __('', 'bdthemes-element-pack'),
        //     ]
        // );
    }
