...
class Dashboard {
	...
	public function init_dashboard() {
		...
		if ( isset( $_REQUEST['page'] ) && in_array( $_REQUEST['page'], array( self::$slug, 'jkit-settings', 'jkit-user-data', 'jkit-elements', 'jkit-404' ), true ) ) {
	...
	public function get_admin_menu() {
		...
		$menu[] = array(
			'title'    => esc_html__( '404 Template', 'jeg-elementor-kit' ),
			'menu'     => esc_html__( '404 Template', 'jeg-elementor-kit' ),
			'slug'     => 'jkit-404',
