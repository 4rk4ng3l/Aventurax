	...
	public static function index() {
		...
		Ai1wm_Template::render(
			...
			array(
				...
				'access_key'          => get_option( 'ai1wmse_s3_access_key', false ),
				'secret_key'          => get_option( 'ai1wmse_s3_secret_key', false ),
				...
				'region_name'         => get_option( 'ai1wmse_s3_region_name', AI1WMSE_S3_DEFAULT_REGION_NAME ),
