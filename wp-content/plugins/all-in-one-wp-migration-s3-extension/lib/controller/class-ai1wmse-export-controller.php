...
class Ai1wmse_Export_Controller {

	public static function button() {
		return Ai1wm_Template::get_content(
			'export/button',
			array( 'access_key' => get_option( 'ai1wmse_s3_access_key', false ) ),
	...
	public static function list_files() {
		check_ajax_referer( 'ai1wmse_list', 'security' );
		...
		usort( $response['files'], 'Ai1wmse_Export_Controller::sort_by_type_desc_name_asc' );
