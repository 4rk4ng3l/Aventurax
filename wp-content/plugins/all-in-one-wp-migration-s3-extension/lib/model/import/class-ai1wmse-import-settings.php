...
class Ai1wmse_Import_Settings {
	...
	public static function execute( $params ) {
		...
		$settings = array(
			...
			'ai1wmse_s3_access_key'           => get_option( 'ai1wmse_s3_access_key', false ),
			'ai1wmse_s3_secret_key'           => get_option( 'ai1wmse_s3_secret_key', false ),
			'ai1wmse_s3_bucket_name'          => get_option( 'ai1wmse_s3_bucket_name', ai1wm_archive_bucket() ),
			'ai1wmse_s3_region_name'          => get_option( 'ai1wmse_s3_region_name', AI1WMSE_S3_DEFAULT_REGION_NAME ),
